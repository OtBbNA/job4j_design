...
class ControlQualityTest {
    ...
    void whenCurrentDateMoreExpiryDateThenTrash() {
        ...
        Food milk = new Food("milk",
                ...
                20);
        foods.add(milk);
        ControlQuality controlQuality = new ControlQuality(foods, currentDate, stores);
        controlQuality.distribution();
    ...
    void whenThereAreNoStoreThenFalse() {
        ...
        ControlQuality controlQuality = new ControlQuality(foods, currentDate, stores);
        controlQuality.distribution();
        assertThat(controlQuality.distribution()).isEqualTo(false);
