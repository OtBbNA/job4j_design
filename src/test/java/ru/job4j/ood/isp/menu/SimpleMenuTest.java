...
public class SimpleMenuTest {
    ...
    @Test
    public void whenSelectWrongThenOptionalIsEmpty() {
        Menu menu = new SimpleMenu();
        menu.add(Menu.ROOT, "Сходить в магазин", STUB_ACTION);
        menu.add("Сходить в магазин", "Купить продукты", STUB_ACTION);
        assertThat(menu.select("Сходить в автомастерскую").isEmpty()).isTrue();
    }

    @Test
    public void whenPrintAddElementsThenPrintLikeExpected() {
        Menu menu = new SimpleMenu();
        String separator = System.lineSeparator();
        MenuPrinter printer = new MenuPrinter.SimpleMenuPrinter();
        menu.add(Menu.ROOT, "Сходить в магазин", STUB_ACTION);
        menu.add(Menu.ROOT, "Покормить собаку", STUB_ACTION);
        menu.add("Сходить в магазин", "Купить продукты", STUB_ACTION);
        menu.add("Купить продукты", "Купить хлеб", STUB_ACTION);
        ...
        StringBuilder expected = new StringBuilder()
                .append("1.Сходить в магазин").append(separator)
